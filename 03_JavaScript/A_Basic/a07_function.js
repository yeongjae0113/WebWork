...
console.log(sayAnthem); // sayAnthem 의 타입? 까지 불러온다
console.log(sayAnthem.toString()); // .toString() 까지 해줘야 sayAnthem 내부까지 불러온다
...
// JS 에선 매개변수가 정의된 함수를 호출할 때 인자 값을 지정하지 않으면, undefined 값이 전달된다!
sayName();
